                                        ...
                                        <div className="">
                                            ...
                                            <div className="container  rounded mt- mb- px-0">
                                                    ...
                                                    <form className="form-horizontal">
                                                        ...
                                                        <div className="form-group row ">
                                                            <div className="col-3 px-3 loginbutton">
                                                                ...
                                                                <Link to="/register">
                                                                   <button type="button" defaultValue="Login" class="btn btn-block btn-info">LOGIN</button>
                                                                   </Link>
                                                                </div>
                                                ...
                                                <div className="mx-0 px-0 bg-light">
                                                    ...
                                                    <div className="pt-0">
                                                        <div className="row justify-content-center">
                                                            <h6>if you have no account Registration?<span><a href="#" className="text-info"> Registration!</a></span></h6>
                                                        </div>
